...
def makeCSVFromDBF(DbfPath,curPeriod):
    ...
    for record in tableDBF:
        print(str(record['SYS_ZDM'])[0:12],curYear,str(record['SYS_ZDM'])[12:14],record['F_2'],record['F_3'],record['F_7'],
          ...
          record['F_25'],record['F_28'],record['F_33'],record['F_34'],record['F_46'],record['F_49'],record['F_52'],record['F_61'],
